...
public class WholesaleMenuRecycleViewAdapter extends RecyclerView.Adapter<WholesaleMenuRecycleViewAdapter.ModelViewHolder> {
    Context context;
    ArrayList<WholesaleMenuModelData> modelArrayList=new ArrayList<>();
    SQLiteDatabase sqLiteDatabase;
    //generate constructor

    public WholesaleMenuRecycleViewAdapter(Context context, int singledata, ArrayList<WholesaleMenuModelData> modelArrayList, SQLiteDatabase sqLiteDatabase) {
    ...
    @NonNull
    @Override
    public WholesaleMenuRecycleViewAdapter.ModelViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater=LayoutInflater.from(context);
        View view=inflater.inflate(R.layout.row_display_wholesale_menu_data,null);

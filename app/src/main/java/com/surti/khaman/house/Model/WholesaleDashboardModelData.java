...
public class WholesaleDashboardModelData {
    private String item_name, weight, price, amount, fixed_price, fixed_weight;

    public WholesaleDashboardModelData(String item_name, String weight, String price, String amount, String fixed_price, String fixed_weight) {
